<div class="main_contenido">
    <div class="main_principal">
        ...
        <p class="fs-1">El uso de Mediabur es bajo tu responsabilidad. No nos hacemos responsables de fallos técnicos, uso indebido del sitio, o enlaces externos.</p>

        <h3>Modificaciones</h3>
        <p class="fs-1">Nos reservamos el derecho de modificar el sitio y sus contenidos sin previo aviso.</p>

        <h3>Enlaces</h3>
        <p class="fs-1">Mediabur puede contener enlaces a sitios externos, pero no somos responsables de su contenido ni garantizamos su disponibilidad o veracidad.</p>

        <h3>Derechos de Exclusión</h3>
        <p class="fs-1">Podemos denegar o retirar el acceso a Mediabur a usuarios que incumplan estas condiciones.</p>
